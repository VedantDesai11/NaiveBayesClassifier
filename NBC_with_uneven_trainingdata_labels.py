...
def calculatePrecisionAndRecall(pred):
...
def main():
    ...
    for x in range(10):
        ...
        dataSet1 = dataSetLabel0(mu1, sigma1, 700)
        dataSet2 = dataSetLabel0(mu1, sigma1, 500)
        dataSet3 = dataSetLabel1(mu2, sigma2, 300)
        ...
        numberOf0, numberOf1 = calculatePrecisionAndRecall(pred)
        zerosAndOnes.append([numberOf0,numberOf1])
